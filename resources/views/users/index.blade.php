        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <img src="{{asset($user->profile->image)}}" alt="" width="50" height="50" class="rounded-circle"
                        alt="{{$user->name}}"></td>
                @else
                <td> <img src="" alt="" width="50" height="50" class="rounded-circle" alt="{{$user->name}}"></td>
                @endif
                ...
                <td class='m-1 p-1 text-center'><a href="{{route('user.edit', $user->id)}}"><i class="fa fa-edit "></i>
                    </a>
                </td>
